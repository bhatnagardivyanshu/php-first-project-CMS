...
<div id="main">
	...
	<form action="edit_page.php?page=<?php echo $current_page['id'] ?>" method="post">
		...
		<p>
			...
			<select name="position">
				<?php 
					$page_count = mysqli_num_rows(find_pages_for_subject($current_page['subject_id'], false));
	...
	<a href="manage_content.php?subject=<?php echo $current_page['subject_id']; ?>">Cancel</a>
	&nbsp;
